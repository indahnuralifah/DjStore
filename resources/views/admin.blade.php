...
<head>
  ...
  <link rel="stylesheet" href="{{url('/assets/vendor/datatables-bootstrap/dataTables.bootstrap.css')}}">
  <link rel="stylesheet" href="{{url('/assets/vendor/datatables-fixedheader/dataTables.fixedHeader.css')}}">
  <link rel="stylesheet" href="{{url('/assets/vendor/datatables-responsive/dataTables.responsive.css')}}">   
...
<body class="dashboard">
  <nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation">
      ...
      <div class="navbar-brand navbar-brand-center site-gridmenu-toggle" data-toggle="gridmenu">
        ...
        <span class="navbar-brand-text"> DJStore</span>
      </div>
    </div>
