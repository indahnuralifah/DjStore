...
<html>
  <head>
    ...
    <link rel="stylesheet" href="{{ url('assets/lugins/iCheck/flat/blue.css')}}">
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="index2.html" class="logo">
          ...
          <span class="logo-lg"><b>Admin</b>DJStore</span>
        </a>
    ...
    <!-- jQuery UI 1.11.4 -->
    <script src="{{url ('assets/https://code.jquery.com/ui/1.11.4/jquery-ui.min.js"></script>
